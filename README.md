...
Full-Stack Developer & Offensive Security Enthusiast from Bojonegoro, Indonesia 🇮🇩
...
**Backend Development**
```
Node.js • Express • NestJS • Python • FastAPI • Laravel • PHP
```
...
- 🔐 Learning offensive security & ethical hacking
- 🐛 Practicing bug bounty hunting
- 📚 Studying web application security vulnerabilities
